...
var polygon = new Shape(1000).getType();
...
var shortStory = new House(1).isATallStory(10);
...
var cookieMonsterBlocked = new Cookie('snickerdoodle').swipedByCookieMonster('Friday');
